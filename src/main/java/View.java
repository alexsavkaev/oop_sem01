...
public class View {
        ...
        public static void view() {
            ...
            step++;
            Main.teams.forEach((v) -> l[0] = Math.max(l[0], v.getInfo().length()));
            System.out.print("_".repeat(l[0]*2));
            System.out.println("");
            System.out.print(top10 + "    ");
            System.out.print(AnsiColors.ANSI_RED+":\tRed side"+AnsiColors.ANSI_RESET);
            ...
            System.out.print("|    ");
            System.out.print(Main.teamRed.get(0).getInfo());
            tabSetter(Main.teamRed.get(0).getInfo().length(), l[0]);
            System.out.println(Main.teamBlue.get(0).getInfo());
            ...
            for (int i = 2; i < 10; i++) {
                ...
                System.out.print("|    ");
                System.out.print(Main.teamRed.get(i-1).getInfo());
                tabSetter(Main.teamRed.get(i-1).getInfo().length(), l[0]);
                System.out.println(Main.teamBlue.get(i-1).getInfo());
                System.out.println(midl10);
            }
            for (int j = 1; j < 11; j++) {
            ...
            System.out.print("|    ");
            System.out.print(Main.teamRed.get(9).getInfo());
            tabSetter(Main.teamRed.get(9).getInfo().length(), l[0]);
            System.out.println(Main.teamBlue.get(9).getInfo());
